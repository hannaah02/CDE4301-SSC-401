% Scaled system
function FR_lm = flowrate_by_system_size(power_receiver, inlet_T, outlet_T, no_rigs)
    % General properties
    g = 9.81;
    ...
    R_length = 10.41 * no_rigs; % m Length of receiver coil
    
    % Receiver power input
    R_power = power_receiver * no_rigs; % W
