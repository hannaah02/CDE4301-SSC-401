function [NPSHa, sys_head] = NPSH_system_head_single(flow_rate, pipe_ID, L_npsh, no_rigs, pipe_length_by_rig, receiver_height) % FR in l/min
...
f_pipe = 0.02;
% f_pipe = (1/(-2.0 * log((roughness_coeff/pipe_ID)/3.7)))^2;
