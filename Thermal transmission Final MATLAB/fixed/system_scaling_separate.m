...
title('Thermal efficiency of pipe in island vs Island size (Parallel)');
...
title('NPSH available vs Island size (1/8 inch pipe) (Parallel)');
...
title('Head in island vs Island size (1/8 inch pipe) (Parallel)');
...
xlabel('Island size');
ylabel('NPSH available in island/m');
title('NPSH available vs Island size (3/4 inch pipe) (Parallel)');
...
xlabel('Island size');
ylabel('Head in island/m');
title('Head in island vs Island size (3/4 inch pipe) (Parallel)')
...
xlabel('Island size');
ylabel('NPSH available in island/m');
title('NPSH available vs Island size (1 inch pipe) (Parallel)');
...
xlabel('Island size');
ylabel('Head in island/m');
title('Head in island vs Island size (1 inch pipe) (Parallel)')
...
xlabel('Island size');
ylabel('NPSH available in island/m');
title('NPSH available vs Island size (comparison) (Parallel)');
...
xlabel('Island size');
ylabel('Head in island/m');
title('Head in island vs Island size (comparison) (Parallel system)')
