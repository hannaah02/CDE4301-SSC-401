const table9 = new gridjs.Grid({
  data: [
    ...
    [gridjs.html("Power consumption"), "100 - 240 W"],
    [gridjs.html("Pump height"), "0m above ground"],
    [gridjs.html("Length of tubing"), gridjs.html("Receiver length: 10.41 m<br />Intermediate piping length: 3m")],
    ...
    [gridjs.html("Maximum heat loss"), "5% of power absorbed: 7.11 W"],
  ],
});
...
const table1 = new gridjs.Grid({
  ...
  data: [
    ["Water", gridjs.html("<math><mi>0</mi></math>"), gridjs.html("<math><mi>100</mi></math>"), gridjs.html("Safe"), gridjs.html("<math><mi>0.0025</mi></math>"), gridjs.html("<math><mi>4.180</mi></math>"), gridjs.html("<math><mi>0.65091</mi></math>"), gridjs.html("<math><mi>1000</mi></math>"), gridjs.html("<math><mi>1.0518</mi></math>")],
    ["Water-Ethanol solution (10-50%)", gridjs.html("<math><mo>-</mo><mi>10</mi></math>"), gridjs.html("<math><mi>150</mi></math>"), gridjs.html("Flammable,<br />skin irritant,<br />eye irritant,<br />respiratory irritation"), gridjs.html("<math><mi>1.5</mi></math>"), gridjs.html("<math><mi>3.5</mi><mo>-</mo><mi>4.0</mi></math>"), gridjs.html("<math><mi>0.4</mi><mo>-</mo><mi>0.55</mi></math>"), gridjs.html("<math><mi>850</mi></math>"), gridjs.html("<math><mi>1.5</mi><mo>-</mo><mi>0.4</mi></math>")],
    ["Synthetic oil (Therminol VP-1)", gridjs.html("<math><mi>15</mi></math>"), gridjs.html("<math><mi>393</mi></math>"), gridjs.html("Skin irritant,<br />harmful if inhaled,<br />respiratory irritant"), gridjs.html("<math><mi>2.1</mi></math>"), gridjs.html("<math><mi>2.37</mi><mo>-</mo><mi>2.73</mi></math>"), gridjs.html("<math><mi>0.095</mi><mo>-</mo><mi>0.077</mi></math>"), gridjs.html("<math><mi>815</mi><mo>-</mo><mi>673</mi></math>"), gridjs.html("<math><mi>0.25</mi><mo>-</mo><mi>0.12</mi></math>")],
    ["NaK Eutectic Alloy (NaK-78)", gridjs.html("<math><mo>-</mo><mi>12.6</mi></math>"), gridjs.html("<math><mi>785</mi></math>"), gridjs.html("Water reactive,<br />skin corrosion,<br />serious eye damage"), gridjs.html("<math><mi>2</mi></math>"), gridjs.html("<math><mi>0.872</mi><mo>-</mo><mi>0.893</mi></math>"), gridjs.html("<math><mi>24.1</mi><mo>-</mo><mi>26.3</mi></math>"), gridjs.html("<math><mi>659</mi><mo>-</mo><mi>779</mi></math>"), gridjs.html("<math><mi>0.279</mi><mo>-</mo><mi>0.131</mi></math>")],
  ],
  /* References!!
  https://www.pub.gov.sg/Public/WaterLoop/Water-Price
  https://www.engineeringtoolbox.com/water-liquid-gas-thermal-conductivity-temperature-pressure-d_2012.html
  https://www.columbuschemical.com/MSDS/SDS/Ethanol%2050%25%2C%20%28v-v%29%208589.pdf
  https://americasinternational.com/wp-content/uploads/2020/03/THERMINOL-VP1-SDS-EASTMAN.pdf
  https://www.espimetals.com/index.php/msds/799-Potassium%20Sodium%20Alloy
  https://www.semanticscholar.org/paper/Literature-Review-on-Heat-Transfer-Fluids-and-in-Heller/05353e299330ac84882ab456a6c63fcd9ecc3118
   */
});
...
const table8 = new gridjs.Grid({
  ...
  data: [
    ["Grothen G328A", gridjs.html("<ul><li>Output Voltage: 24V 1A</li><li>Flow rate: 0.114 - 0. 500 l/min</li><li>DC Motor: 12V</li></ul>"), gridjs.html("<b>Cons:</b><br />-<br /><b>Pros:</b><br />0.114 l/min gives about <math><mi>17.9</mi><mo>&deg;</mo><mi>C</mi></math> change and 0.500 l/min gives about <math><mi>4.1</mi><mo>&deg;</mo><mi>C</mi></math> change, which is within the range required.")],
    ["Grothen G928", gridjs.html("<ul><li>Motor Power: 12V, 24V(Optional)</li><li>Type: Peristaltic pump</li><li>Flow rate: 0.500 l/min</li></ul>"), gridjs.html("<b>Cons:</b><br />0.500 l/min gives about <math><mi>4.1</mi><mo>&deg;</mo><mi>C</mi></math> change, which is slightly out of the requirements<br />Modifications are required to ensure it can be used outdoors<br /><b>Pros:</b><br />As connections have to be done ourselves, it will be easier to connect to solar panels.")],
    ["USB Mini Submersible Water Pump", gridjs.html("<ul><li>Power: 0.4-1.5W</li><li>DC Voltage: 2.5-6V</li><li>Working current: 130-220mA</li><li>Head: 0.40-1.10</li><li>Flow rate: 1.33 - 2.00 l/min</li></ul>"), gridjs.html("<b>Cons:</b><br />This is one of the lowest possible flow rate for aquarium pumps and the flow rate of 1.33 l/min gives about <math><mi>1.54</mi><mo>&deg;</mo><mi>C</mi></math> change and 2.00 l/min gives about <math><mi>1.02</mi><mo>&deg;</mo><mi>C</mi></math> change, which is very small.<br /><b>Pros:</b><br />Since it is submersible, it will not take space within the limited space below the receiver and reflectors.<br />Also, it does not require as much modification to make it suitable for usage outdoors.")],
  ],
});
table8.render(document.getElementById("Pump-options"));
/* References!!
https://www.amazon.com/NTBL-Peristaltic-114-500ml-Adjustable-Vulcanized/dp/B0BNL1514C
...
const table10 = new gridjs.Grid({
  ...
  data: [
    ["Goethe G328A", "0.114 - 0. 500", gridjs.html("4.1 - 17.9"), "100 - 240", "86.98"],
    ["Grothen G928", "0.500", gridjs.html("4.1"), "48 - 96", "38.18"],
    ["USB Mini Submersible Water Pump", "1.33 - 2.00", gridjs.html("1.02 - 1.54"), "0.4 - 1.5", "5"],
  ],
});
...
const table11 = new gridjs.Grid({
  columns: ["Insulation material", gridjs.html("Thermal conductivity <math><mi>W</mi><mo>/</mo><mi>m</mi><mi>K</mi></math>"), "Cost per unit length", "Thickness required", "Cost per unit length to meet thickness required", "Durability"],
  data: [
    ["Aerogel", gridjs.html("0.014"), "14.15 SGD for 3mm", "8.510679 mm", "40.15 SGD", "20-30 years"],
    ["Polyisocyanurate/ Polyurethane foam (PIR/PUR)", gridjs.html("0.023 – 0.026"), "0.24 SGD for 2cm", "21.708707 mm - 28.617394 mm", "0.26 - 0.35 SGD", "40 years"],
    ["Polyethelyne (PE) foam", gridjs.html("0.04"), "0.10 SGD for 5mm", "94.079069 mm", "1.90 SGD", "15-20  years"],
  ],
});
table11.render(document.getElementById("Insulation-table"));
/* References
https://shopee.sg/Silica-Nano-Aerogel-CompoSite-Thermal-insulation-Blanket-Silica-Thermal-insulation-Material-Nano-Thermal-insulation-Gel-Board-i.1356232114.29878292492
https://shopee.sg/product/280224396/19407230558?gads_t_sig=VTJGc2RHVmtYMTlxTFVSVVRrdENkY0N5akVpcE5OamJEdjRRTHBOTzhma0tPTDdGMkNHK2pnbDREOFQrOGpaRzRsclp1Y2RQbnNQNHZ1KzAya2FjWmxlNDBUY01DaUx2NFk4aGJUUjcrVlNHYXNkRFZqZG1qc1dXUlZLbzRQeng&gad_source=1&gad_campaignid=1690731353
https://shopee.sg/product/265054860/27713302260?gads_t_sig=VTJGc2RHVmtYMTlxTFVSVVRrdENkY0N5akVpcE5OamJEdjRRTHBOTzhma0N0WjlCZDNmbXQ1eExIN0M1NlNWa2RFUUdYNG1FSXd2azkralQyMzNMY09OL09zc000dzk1dFJjcUFsQ2RyeWpqY3BxdWRScjNEODZXNWhRUG82dWo
https://www.farersteelpipe.com/blog/what-is-the-typical-lifespan-of-aerogel-felt-in-different-applications-1329997.html
https://www.generalplastics.com/blog/10-things-you-must-know-before-using-polyurethane-foam-boards-for-insulation
https://www.lukwom.com/What-is-the-life-expectancy-of-PE-insulation-id48918585.html
http://www.greenspec.co.uk/building-design/insulation-materials-thermal-properties/
https://therubbercompany.com/sponge-foam/polyethylene-foam/polyethylene-foam
https://www.alaskapuf.com/difference-between-pir-and-puf-insulation.php */
