const table2 = new gridjs.Grid({
  ...
  data: [
    ...
    [gridjs.html("Heat transfer coefficient (HTC) in transient heat conduction"), gridjs.html("Heat transfer coefficient describes the efficiency of the heat transfer.<br /><br /><math><mi>HTC</mi><mo>=</mo><msqrt><mfrac><mrow><mi>k</mi><mi>&rho;</mi><msub><mi>C</mi><mn>p</mn></msub></mrow><mrow><mi>t</mi></mrow></mfrac></msqrt></math>,<br />where <math><mi>HTC</mi></math> is the heat transfer coefficient,<br /><math><mi>k</mi></math> is the thermal conductivity,<br /><math><mi>&rho;</mi></math> is the density,<br /><math><msub><mi>C</mi><mn>p</mn></msub></math> is the specific heat capacity, and<br /><math><mi>t</mi></math> is the time. [81]")],
    /* References!!!
    ...
    */
    ...
    [gridjs.html("Nusselt number (Nu)"), gridjs.html("Nusselt number is the ratio between the convective and conductive heat transfer. Nusselt number is also a function of Reynold's number and Prandtl's number.<br /><br /><math><mi>Nu</mi><mo>=</mo><mfrac><mrow><mi>hL</mi></mrow><mrow><mi>k</mi></mrow></mfrac></math>,<br />where <math><mi>h</mi></math> is the convective heat transfer coefficient,<br /><math><mi>L</mi></math> is the charactertistic length, and<br /><math><mi>k</mi></math> is the thermal conductivity. [83]<br /><br /><b>For flat plate (laminar):</b> <math><mi>Nu</mi><mo>=</mo><mi>0.664</mi><msup><mi>Re</mi><mn>0.5</mn></msup><msup><mi>Pr</mi><mn>1/3</mn></msup></math> for <math><mi>Re</mi><mo>></mo><mi>5</mi><mo>&times;</mo><msup><mi>10</mi><mn>5</mn></msup></math><br /><b>For circular tube under constant surface temperature (laminar):</b> <math><mi>Nu</mi><mo>=</mo><mi>3.66</mi></math><br /><b>For cicular tube under constant surface heat flux (laminar):</b> <math><mi>Nu</mi><mo>=</mo><mi>4.36</mi></math>,<br />where Re is Reynold's number, and<br />Pr is Prandtl's number. [84]")],
    /* References!!!
    ...
    */
    ...
    [gridjs.html("Static Head (HS), <math> <mi>m</mi></math>"), gridjs.html("Static head is the total vertical distance between the surface of the water's origin to its destination. [85]")],
    /* References!!
    https://iwakiamerica.com/blog/the-science-behind-total-dynamic-head-and-its-relevance-in-fluid-dynamics/ */

    [gridjs.html("Friction Head (HF), <math> <mi>m</mi></math>"), gridjs.html("Friction head is the head loss due to friction as the fluid moves through the pipe. [85]")],
    /* References!!
    https://iwakiamerica.com/blog/the-science-behind-total-dynamic-head-and-its-relevance-in-fluid-dynamics/ */

    [gridjs.html("Pressure Head (HP), <math> <mi>m</mi></math>"), gridjs.html("Pressure head is the pressure the pump needs to overcome. [86]")],
    /* References!!
    https://www.globalpumps.com.au/blog/what-role-does-head-pressure-play */

    [gridjs.html("Total Dynamic Head (TDH), <math> <mi>m</mi></math>"), gridjs.html("Summation of the head losses in a fluid system. It is the equivalent height the pump needs to raise the fluid and is used as a gauge for the energy required to pump a fluid through a system. [85][87]")],
    /* References!!
    ...
    [gridjs.html("Net Positive Suction Head Required (NPSHr), <math> <mi>m</mi></math>"), gridjs.html("NPSHr is the lowest inlet pressure required for the pump to work properly and reduce cavitation or flashing. [88]")],
    /* References!! 
    https://www.grundfos.com/sg/learn/research-and-insights/npsh-net-positive-suction-head */
    ...
    [gridjs.html("AC Current input"), gridjs.html("<math><msub><mi>I</mi><mn>AC</mn></msub><mo>=</mo><mfrac><mrow><msub><mi>P</mi><mn>DC</mn></msub></mrow><mrow><mi>PF</mi><mo>&dot;</mo><mi>&eta;</mi><mo>&dot;</mo><msub><mi>V</mi><mn>AC</mn></msub></mrow></mfrac></math>,<br />where <math><msub><mi>I</mi><mn>AC</mn></msub></math> is the AC input current (for 1-phase),<br /><math><mi>PF</mi></math> is the power factor,<br /><math><mi>&eta;</mi></math> is the efficiency, and<br /><math><msub><mi>V</mi><mn>AC</mn></msub></math> is the AC input voltage. [91]")],
    /* References!!
    [29] https://magna-power.com/learn/kb/calculating-power-supply-ac-input-current */

    [gridjs.html("Power factor (PF)"), gridjs.html("Power factor is a measure of energy efficiency and is the ratio of the working power (in kW) to apparent power (in kVA). [92]")],
    /* References!!
    [30] https://www.fluke.com/en-sg/learn/blog/power-quality/power-factor-formula */

    [gridjs.html("Power factor correction (PFC)"), gridjs.html("Power factor correction is the methods used to improve a device's power factor. [93]")],
    /* References!!
    [31] https://www.monolithicpower.com/en/learning/resources/power-factor-correction */

    [gridjs.html("Switching power supply (SMPS)"), gridjs.html("SMPS is a form of AC to DC power converter that has higher efficiency than linear power supply. [94]")],
    /* References!!
